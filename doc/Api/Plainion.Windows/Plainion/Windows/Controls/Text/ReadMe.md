...
# Plainion.Windows.Controls.Text
...
* [DocumentStoreExtensions](DocumentStoreExtensions.md)
* [Document](Document.md)
* [DocumentOperations](DocumentOperations.md)
* [DocumentId](DocumentId.md)
* [FileSystemDocumentStore](FileSystemDocumentStore.md)
* [Folder](Folder.md)
* [FolderId](FolderId.md)
* [DocumentStore](DocumentStore.md)
* [IStoreItem](IStoreItem.md)
* [SearchMode](SearchMode.md)
* [StoreItemMetaInfo](StoreItemMetaInfo.md)
